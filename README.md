...
- [CodeRunner](https://coderunnerapp.com/)
  - Running small code snippets but yeah, there's also [`repl.it`](https://repl.it/)
...
I use the lovely [Aerial screensaver](shttps://github.com/JohnCoates/Aerial) which even allows me to have different 3D views on different monitors.
